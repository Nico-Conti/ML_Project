...
save_image_val(metrics['trial_train_losses'][0], metrics['trial_val_losses'][0], metrics['trial_val_accs'][0], "config/monk_2/hold_out_monk_2.png")

save_config_to_json(best_config, "config/monk_2/config_hold_monk_2.json")
# save_config_to_json(all_configs, "config/monk_2/all_config_hold_monk_2.json")
