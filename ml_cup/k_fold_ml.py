...
save_config_to_json(config, "config/ml_cup/k_fold/config_k_fold_ml.json")
...
save_image_test(train_loss_list, test_loss_list, f"config/ml_cup/k_fold/hold_out_test.png")
